...
// Rectangle chassis 
  ...
  public static final HolonomicPathFollowerConfig pathFollowerConfig = new HolonomicPathFollowerConfig(
      ...
      new PIDConstants(5.0, 0, 0), // Rotation constants 
      maxModuleSpeed, 
      kFrontLeftChassisAngularOffset.getNorm(), // Drive base radius (distance from center to furthest module) 
      new ReplanningConfig()
    );
  }*/
  public static final class ModuleConstants {
     ...
     * 
     */
    public static final double kDrivingMinOutput = -0.6;
    public static final double kDrivingMaxOutput = 0.6;
...
// Here you can change the idle mode to coast 
    //public static final IdleMode kDrivingMotorIdleMode = com.revrobotics.CANSparkBase.IdleMode.kCoast;
